...
(async () => { try {
  ...
  console.log("home hidden:", await c.evalp(`JSON.stringify({cls:document.documentElement.classList.contains("wy-lobby"),mybox:getComputedStyle(document.getElementById("mybox")).visibility,chat:getComputedStyle(document.getElementById("bchat")||document.body).visibility,thbtn:getComputedStyle(document.getElementById("wy-thbtn")).visibility,lobby:getComputedStyle(document.getElementById("wy-lb")).visibility})`));
  ...
  await click('#lb-home');
  console.log("home closes:", await c.evalp(`JSON.stringify({closed:!NTL_LB.open_,cls:document.documentElement.classList.contains("wy-lobby"),mybox:getComputedStyle(document.getElementById("mybox")).visibility})`));
